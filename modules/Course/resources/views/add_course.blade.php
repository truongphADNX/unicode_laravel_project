        ...
        <div class="row">
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input class="form-control title @error('name') is-invalid @enderror" type="text" value="{{ old('name') }}" placeholder="Input full name ..." name="name">
                    @error('name')
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input class="form-control slug @error('slug') is-invalid @enderror" type="text" value="{{ old('slug') }}" placeholder="" name="slug">
                    @error('slug')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <select name="teacher_id" id="" class="form-select @error('teacher_id') is-invalid @enderror">
                        ...
                        <option value="1" @if (old('teacher_id') == "1") {{ 'selected' }} @endif >Tiến Bịp</option>
                    </select>
                    @error('teacher_id')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" type="text" placeholder="Input course code ..." name="code">
                    @error('code')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}" type="number" placeholder="Input course price ..." name="price">
                    @error('price')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input class="form-control @error('sale_price') is-invalid @enderror" value="{{ old('sale_price') }}" type="number" placeholder="Input course sale price ..." name="sale_price">
                    @error('sale_price')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
