        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <input class="form-control slug @error('slug') is-invalid @enderror" value="{{ old('slug') }}"
                        type="text" placeholder="Input user slug ..." name="slug">
                    @error('slug')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <input class="form-control @error('exp') is-invalid @enderror" value="{{ old('exp') }}"
                    ...
                    <div class="row  {{ $errors->has('image') ? 'align-items-center' : 'align-items-end' }}">
                        <div class="col-8">
                            ...
                            <input type="text" id="image" class="form-control @error('image') is-invalid @enderror"
                                value="{{ old('image') }}" placeholder="Input image ..." name="image">
                            @error('image')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
